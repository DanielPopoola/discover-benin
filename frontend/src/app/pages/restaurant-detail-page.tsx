...
import {
  ...
  Phone, ChevronLeft, ChevronRight as ChevronRightIcon,
} from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[58vh] min-h-[400px] overflow-hidden mt-20">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 pb-10">
          <div className="max-w-[1280px] mx-auto px-8">
            <div
              className="inline-block text-[#C4622D] bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full mb-3"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl p-8">
                ...
                <p
                  className="text-[#5C3A1E]/80 leading-relaxed"
                      ...
                      <div className="space-y-0 divide-y divide-[rgba(92,58,30,0.07)]">
                        {section.items.map((item) => (
                          <div key={item.name} className="flex items-start justify-between py-4 gap-6">
                            ...
                            <div
                              className="text-[#C4622D] shrink-0"
              ...
              <div className="bg-white rounded-2xl p-8">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {restaurant.features.map((feature) => (
                    <div key={feature} className="flex items-center gap-2.5 text-sm text-[#5C3A1E]"
            ...
            <div className="lg:sticky lg:top-24 h-fit space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-[rgba(92,58,30,0.15)] shadow-[0_8px_30px_rgba(0,0,0,0.07)]">
                <div className="space-y-0 divide-y divide-[rgba(92,58,30,0.08)]">
                  {[
                    ...
                    <div key={label} className="flex justify-between items-start gap-4 py-3.5">
                      <span
                        className="text-[#5C3A1E]/60 text-sm shrink-0"
                        style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}
                      >
                        {label}
                      </span>
                      <span
                        className="text-[#1A1A1A] text-sm text-right"
                        style={{ fontFamily: "var(--font-body)", fontWeight: 500 }}
                      >
                        {value}
                      </span>
                      ...
                      <Star
                        ...
                        className={
                          star <= Math.floor(restaurant.rating)
                            ? "text-[#D4A827] fill-[#D4A827]"
                            : "text-[#D4A827]/30 fill-[#D4A827]/30"
                        }
                      />
                    ))}
                  </div>
                ...
                <p
                  className="text-[#5C3A1E]/50 text-xs mt-1"
              ...
              <div className="bg-white rounded-2xl p-6 border border-[rgba(92,58,30,0.15)]">
                ...
                <div className="space-y-3">
                  ...
                  {restaurant.contact.instagram && (
                    <div
                      className="flex items-center gap-3 text-sm text-[#5C3A1E]"
                      style={{ fontFamily: "var(--font-body)", fontWeight: 400 }}
                    >
              ...
              <div className="bg-white rounded-2xl p-6 border border-[rgba(92,58,30,0.15)]">
                ...
                <div className="h-40 bg-[#F5EFE0] rounded-xl mb-4 flex flex-col items-center justify-center gap-2">
                  ...
                  <p
                    className="text-[#5C3A1E]/70 text-xs text-center px-4 leading-relaxed"
                    style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}
                  >
                    {restaurant.address}
                  </p>
                ...
                <a
                  href={`https://www.google.com/maps/search/${encodeURIComponent(restaurant.name + " " + restaurant.city + " Benin")}`}
                  target="_blank"
