...
import {
  MapPin, Star, ChevronRight, Home, Phone,
  Mail, Globe, Clock, ChevronLeft, ChevronRight as ChevronRightIcon,
} from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-[#F5EFE0] flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4 pt-32">
          ...
          <Link
            to="/hotels"
            className="bg-[#C4622D] text-white px-6 py-3 rounded-lg hover:bg-[#B55626] transition-colors"
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 pb-10">
          <div className="max-w-[1280px] mx-auto px-8">
            ...
            <h1
              ...
              style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.8rem, 4vw, 3rem)", lineHeight: 1.1 }}
            >
              {hotel.name}
            </h1>
            ...
            {allImages.map((img, i) => (
              <button
                ...
                className={`flex-shrink-0 w-20 h-14 rounded-lg overflow-hidden border-2 transition-all ${
                  i === activeImg ? "border-[#C4622D]" : "border-transparent opacity-60 hover:opacity-100"
                }`}
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl p-8">
                <h2 className="text-[#1A1A1A] mb-5" style={{ fontFamily: "var(--font-display)", fontSize: "1.75rem" }}>
                  About {hotel.name}
                </h2>
              ...
              {/* Amenities */}
              <div className="bg-white rounded-2xl p-8">
                <h3 className="text-[#1A1A1A] mb-6" style={{ fontFamily: "var(--font-display)", fontSize: "1.4rem" }}>
                  Amenities
                </h3>
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  {hotel.amenities.map((amenity) => (
                    <div key={amenity} className="flex items-center gap-2.5 text-sm text-[#5C3A1E]"
              ...
              {/* Nearby attractions */}
              <div className="bg-white rounded-2xl p-8">
                <h3 className="text-[#1A1A1A] mb-5" style={{ fontFamily: "var(--font-display)", fontSize: "1.4rem" }}>
                  Nearby Attractions
                </h3>
                <div className="space-y-3">
                  {hotel.nearbyAttractions.map((place) => (
                    <div key={place.name}
                      className="flex items-center justify-between p-4 bg-[#F5EFE0] rounded-xl">
                      ...
                      <span className="text-[#5C3A1E]/60 text-sm"
                ...
                <div className="space-y-0 divide-y divide-[rgba(92,58,30,0.08)]">
                  {[
                    ...
                    <div key={label} className="flex items-start justify-between py-4 gap-4">
                      <div className="flex items-center gap-2.5 text-[#5C3A1E]/60 text-sm shrink-0"
                        style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}>
                        <Clock size={15} />
                        {label}
                      </div>
                      <span className="text-[#1A1A1A] text-sm text-right"
                        style={{ fontFamily: "var(--font-body)", fontWeight: 500 }}>
                        {value}
                      </span>
                    </div>
            ...
            <div className="lg:sticky lg:top-24 h-fit space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 border border-[rgba(92,58,30,0.15)] shadow-[0_8px_30px_rgba(0,0,0,0.07)]">
                <div className="flex items-baseline gap-1 mb-1">
                  <span style={{ fontFamily: "var(--font-display)", fontSize: "2rem", color: "#C4622D" }}>
                    €{hotel.price}
                  </span>
                  <span className="text-[#5C3A1E]/60 text-sm"
                    style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}>
              ...
              <div className="bg-white rounded-2xl p-6 border border-[rgba(92,58,30,0.15)]">
                ...
                <div className="h-44 bg-[#F5EFE0] rounded-xl mb-4 flex flex-col items-center justify-center gap-2">
                  ...
                  <p className="text-[#5C3A1E]/70 text-xs text-center px-4 leading-relaxed"
                    style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}>
                    {hotel.address}
                  </p>
                </div>
                <a
                  href={`https://www.google.com/maps/search/${encodeURIComponent(hotel.name + " " + hotel.city + " Benin")}`}
                  target="_blank"
                  rel="noopener noreferrer"
